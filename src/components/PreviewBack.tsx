...
function PreviewBack({ coupon }: Props) {
  return (
    <div className="flex h-[600px] w-[1200px] shrink-0 flex-nowrap text-tbase shadow-xl">
      <div className="flex flex-1 grow flex-col bg-white">
        <div className="grow">
          <div className="flex justify-between p-8">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="w-full fill-tcontrast"  viewBox="0 0 220 40">
        ...
        <div className="shrink bg-primary p-8">
          <div className="flex">
            <div className="grow">
              <p className="text-xl font-bold uppercase italic text-tcontrast">
              ...
              <p className="text-secondary-0.5 text-2xl italic">
