  ...
  return (
    <div className={`flex h-[600px] w-[1200px] shrink-0 flex-nowrap bg-primary text-tcontrast shadow-xl`}>
      <div className="flex-1 grow">
        ...
        <div className="p-4">
          <p className={`mb-8 border border-x-0 border-y-8 border-y-secondary py-8 text-center text-4xl font-bold `}>
      ...
      <div className={`flex flex-1 grow flex-col bg-secondary text-tcontrast `}>
        ...
        <div className="flex grow flex-col items-center justify-center px-4">
          ...
          <p className={`mb-4 rounded-full bg-primary px-12 py-4 text-3xl font-bold shadow`}>
