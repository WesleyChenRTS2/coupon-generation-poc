...
function PreviewFront({ coupon }: Props) {
  return (
    <div className={`flex h-[600px] w-[1200px] shrink-0 flex-nowrap bg-primary text-tbase shadow-xl`}>
      <div className="flex-1 grow">
        <div className="px-8 pb-4 pt-12">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-full fill-tbase"  viewBox="0 0 220 40">
      ...
      <div className={`flex flex-1 grow flex-col bg-secondary`}>
        <div className="shrink-0">
          <img src={portrait} alt="" />
        </div>
        <div className="flex grow flex-col items-center justify-center px-4">
          <p className={`mb-4 text-xl font-bold text-tbase`}>
            Call today or Conveniently Schedule Online!
          </p>
          <p className={`mb-4 rounded-full bg-primary px-12 py-4 text-3xl font-bold text-tbase shadow`}>
            {coupon.nap?.phone || "Your phone number"}
          </p>
          <p className={`text-xl font-bold text-tcontrast`}>
