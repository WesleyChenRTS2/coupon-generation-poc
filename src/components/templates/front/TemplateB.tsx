...
const TemplateB = (coupon : CouponState) => {
        ...
        <div className="flex h-[600px] w-[1200px] flex-row bg-primary text-tcontrast shadow-xl">
            <div className="flex w-1/2 flex-col">
                ...
                <div className="flex flex-col items-center justify-center bg-secondary p-4 text-tcontrast">
                    ...
                    <p className="mb-4 rounded-full bg-primary px-12 py-4 text-3xl font-bold shadow">{coupon.nap?.phone || "Your phone number"}</p>
            ...
            <div className="flex w-1/2 flex-col bg-primary">
                ...
                <div className="grow p-4">
                    <p className="mb-8 border-0 border-y-8 border-secondary py-8 text-center text-4xl font-bold">{coupon.tagline || "Your tagline"}</p>
                    <ul className="flex flex-col items-center justify-center pl-8 text-xl">
                        {coupon.services.map((service, index) => (
                            <li className="list-disc" key={index}>{service || "Service Name"}</li>
                        ))}
                    </ul>
                </div>
            </div>
